...
{	
	...
	if( _iTerm > 255) _iTerm = 255;
	else if(_iTerm < 0) _iTerm = 0;
	...
	_lastSpeed = speed;
 /*
  Serial.print("SetPoint: "); Serial.print(_setPoint); 
  Serial.print("\tSPD: "); Serial.print(speed); 
  Serial.print("\tP: "); Serial.print(error); 
  Serial.print("\tI: "); Serial.print(_iTerm); 
  Serial.print("\tD: "); Serial.print(dInput);
