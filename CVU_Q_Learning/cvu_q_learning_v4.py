...
class QLearning :
	...
	#		dataLogger removed
	def __init__(self,name,MCU,imageWidth,maxSpeed,ALPHA,LAMBDA,states,actions,rewards,camer,actionDelay,) :
...
agent = QLearning('Vision Q-learning',mcu,240,150,0.1,0.9,states,actions,rewards,CAM,1)

lineDetector = AdaptativeLineDetector(240,64,60,240,64,agent)
